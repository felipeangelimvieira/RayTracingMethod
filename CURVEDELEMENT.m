    ...
    methods
        ...
        function X = PsiPos(obj,w)
            ...
            X = [ 1                 1/Xi2                1/Xi3                0                  0      0;
                  ...
                  -1i*ki1*Xi1    -1i*ki2     -1i*ki3                1/(R*Xo2)                 1/(R*Xo3)      1/R;];
...
%              F3 = E*IIn*(1i*ko1^3*Xo1 + 1i*ko1/R) + G*J/R*(1i*ko1 + 1i*ko1*Xo1/R);  %ok          
        ...
        function x = e1(obj,r)
            r1 = (obj.center-r)/norm(obj.center-r);
        ...
        function X = Delta(obj,w,s)
            X = diag( [exp(-1i*s*obj.ki(w,1)) exp(-1i*s*obj.ki(w,2)) exp(-1i*s*obj.ki(w,3)) exp(-1i*s*obj.ko(w,2)) exp(-1i*s*obj.ko(w,3)) exp(-1i*s*obj.ko(w,1))]);
        end
